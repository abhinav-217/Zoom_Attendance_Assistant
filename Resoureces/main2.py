...
def OpenNext():
    ...
    # print("Something");
    # if(vv1==1):
    #     print("it a request for new file");
    # elif(vv1==0):
    #     print("It's a request for appending to the file");
    if vv1 == 1:
        window = Tk()
        ...
        def display_input1():
            ...
            v1 = var1.get()
            v2 = var2.get()
            print("Input for v1", v1)
            print("Input for v2", v2)
...
if vv1 ==1:
    ...
    try:
        ...
        for x in range(0,len_tup):
            if v1 ==1:
                Extract_Text(abhinav[x],x+1,74,126,608,1458)
                RmNewLine()
                Sorting_of_file()
                CpyToFinal(path,file_name)
                rmfirst()
            elif v1 == 0:
                Extract_Text(abhinav[x],x+1,1484,166,1840,1024)
                RmNewLine()
                Sorting_of_file()
                CpyToFinal(path,file_name)
                rmfirst()
